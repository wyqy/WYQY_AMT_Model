...
def detect_multitone_model_cnn_build() -> keras.Model:
    """
    ...
    conv_1 = layers.Conv2D(
        filters=10, kernel_size=(2, 15), strides=(1, 1),
    ...
    relu_1 = layers.ReLU(
        max_value=None, negative_slope=0.1, threshold=0, name='relu_1')(bn_1)
    ...
    relu_2 = layers.ReLU(
        max_value=None, negative_slope=0.1, threshold=0, name='relu_2')(bn_2)
    ...
    relu_4 = layers.ReLU(
        max_value=None, negative_slope=0.1, threshold=0, name='relu_4')(bn_4)
    ...
    fc_5 = layers.Dense(
        ...
        bias_initializer=keras.initializers.Constant(value=1e-3),
        kernel_regularizer=keras.regularizers.L2(l2=4e-3),
        bias_regularizer=None,
        name='fc_5')(reshape_5)
    relu_5 = layers.ReLU(
        max_value=None, negative_slope=0.1, threshold=0, name='relu_5')(fc_5)
    dropout_5 = layers.Dropout(
        rate=0.5, noise_shape=None, name='dropout_5')(relu_5)
...
def detect_start_common_model_cnn_build() -> keras.Model:
    """
    ...
    conv_1 = layers.Conv2D(
        filters=20, kernel_size=(3, 4), strides=(1, 1),
        padding='valid', data_format='channels_last', activation=None,
        kernel_initializer=keras.initializers.HeUniform(),
        bias_initializer=keras.initializers.Zeros(),
        kernel_regularizer=keras.regularizers.L2(l2=5e-5),
    ...
    conv_2 = layers.Conv2D(
        filters=40, kernel_size=(3, 13), strides=(1, 1),
        padding='valid', data_format='channels_last', activation=None,
        kernel_initializer=keras.initializers.HeUniform(),
        bias_initializer=keras.initializers.Zeros(),
        kernel_regularizer=keras.regularizers.L2(l2=5e-5),
    ...
    fc_3 = layers.Dense(
        ...
        name='fc_3')(reshape_3)
    relu_3 = layers.ReLU(
        max_value=None, negative_slope=0.1, threshold=0, name='relu_3')(fc_3)
    dropout_3 = layers.Dropout(
        rate=0.5, noise_shape=None, name='dropout_3')(relu_3)
