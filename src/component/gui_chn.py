...
# 定义常量
FIGURE_FRAMES = 1024
FONT_SET = FontProperties(fname="C:\\windows\\fonts\\MSYH.ttc", size=12)
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def initUI(self):
        ...
        self.initUI_center()
        # 设置窗口的标题
        self.setWindowTitle('NeuralNetwork Based Piano Transcription by YouJingze 1.16')
        # 设置窗口的图标, 引用当前目录下的图片
    ...
    def widgetsSetup(self):
        ...
        self.FileInputButton.setText('打开文件')
        ...
        self.SpecTransformButton.setText('频谱变换')
        ...
        self.ModelPredictButton.setText('模型预测')
        ...
        self.MidiPlayerButton.setText('MIDI 播放')
        ...
        self.MidiOutputButton.setText('MIDI 输出')
        ...
        self.CloseFileButton.setText('关闭文件')
        ...
        self.SpecDiagramFigure.suptitle(u'频谱变换', fontproperties=FONT_SET)
        ...
        self.PredDiagramFigure.suptitle(u'钢琴卷帘', fontproperties=FONT_SET)
    ...
    def matplotDraw(self, data, offset, cmap, figure, canvas):
        ...
        figure.clear()
        # 初始化图片
        figure.suptitle(fig_title, fontproperties=FONT_SET)
