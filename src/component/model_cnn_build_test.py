...
def detect_multitone_model_cnn_build() -> keras.Model:
    ...
    dropout_2 = layers.Dropout(
        rate=0.25, noise_shape=None, name='dropout_2')(pool_2)
    ...
    fc_5 = layers.Dense(
        ...
        bias_regularizer=None,
        name='fc_5')(reshape_5)
    relu_5 = layers.LeakyReLU(alpha=0.1, name='relu_5')(fc_5)
...
def detect_start_common_model_cnn_build() -> keras.Model:
    ...
    conv_1 = layers.Conv2D(
        filters=10, kernel_size=(3, 16), strides=(1, 1),
        padding='valid', data_format='channels_last', activation=None,
        kernel_initializer=keras.initializers.HeUniform(),
        bias_initializer=keras.initializers.Zeros(),
        kernel_regularizer=keras.regularizers.L2(l2=5e-5),
    ...
    relu_1 = layers.LeakyReLU(alpha=0.1, name='relu_1')(bn_1)
    pool_1 = layers.MaxPool2D(
        pool_size=(1, 2), strides=(1, 2), padding='same', data_format='channels_last', name='pool_1')(relu_1)
    ...
    relu_2 = layers.LeakyReLU(alpha=0.1, name='relu_2')(bn_2)
    pool_2 = layers.MaxPool2D(
        pool_size=(1, 2), strides=(1, 2), padding='same', data_format='channels_last', name='pool_2')(relu_2)
    ...
    fc_3 = layers.Dense(
        ...
        bias_regularizer=None,
        name='fc_3')(reshape_3)
    relu_3 = layers.LeakyReLU(alpha=0.1, name='relu_3')(fc_3)
